...
| # | 文件 | 研究主题 | 对应设计文档 |
|---|------|---------|------------|
| 1 | [01_game_rules.md](research/01_game_rules.md) | 三消核心规则、特殊方块、计分 | [data_models](design/data_models.md) [ui_hud](design/ui_hud.md) |
| 2 | [02_board_design.md](research/02_board_design.md) | 棋盘尺寸、网格表示、坐标系统 | [board_system](design/board_system.md) |
| 3 | [03_match_algorithm.md](research/03_match_algorithm.md) | 匹配检测算法、Flood-Fill、Bitboard | [match_system](design/match_system.md) |
| 4 | [04_gravity.md](research/04_gravity.md) | 重力下落、动画时序、障碍物处理 | [gravity_cascade](design/gravity_cascade.md) |
| 5 | [05_cascade.md](research/05_cascade.md) | 级联循环、连锁反应、连击系统 | [gravity_cascade](design/gravity_cascade.md) |
| 6 | [06_state_machine.md](research/06_state_machine.md) | 状态机设计、动画驱动、输入锁定 | [state_machine](design/state_machine.md) [architecture](design/architecture.md) |
| 7 | [07_random_generation.md](research/07_random_generation.md) | 随机策略、死局检测、Bag 系统 | [board_system](design/board_system.md) [match_system](design/match_system.md) |
| 8 | [08_performance.md](research/08_performance.md) | WebGL 优化、Shader、对象池、WASM | [crystal_shader](design/crystal_shader.md) [board_system](design/board_system.md) |
| 9 | [09_future_work.md](research/09_future_work.md) | 关卡系统、障碍物、存档、多平台 | (后续版本) |
| 10 | [10_godot4_syntax.md](research/10_godot4_syntax.md) | Godot 4.x GDScript 语法 & API 速查 | 全部 Design / Task 文件 |
...
|--------|----------|--------|------|
| 游戏规则 | 01_game_rules.md | data_models.md, ui_hud.md | 02 |
| 棋盘和坐标 | 02_board_design.md | board_system.md | 06, 09 |
| 匹配检测 | 03_match_algorithm.md | match_system.md | 03 |
| 下落和引力 | 04_gravity.md | gravity_cascade.md | 04 |
| 级联和连锁 | 05_cascade.md | gravity_cascade.md | 08 |
| 状态机 | 06_state_machine.md | state_machine.md | 08 |
| 视觉效果 | - | crystal_shader.md | 05, 10 |
| 测试与验证 | 09_future_work.md | testing.md | 14 |
| 性能优化 | 08_performance.md | crystal_shader.md, board_system.md | 05, 06 |
| 随机和公平 | 07_random_generation.md | match_system.md, board_system.md | 02, 03 |
| 未来扩展 | 09_future_work.md | - | - |
...
| 01_game_rules.md | research |
| 02_board_design.md | research |
| board_system.md | design |
| 03_match_algorithm.md | research |
| 04_gravity.md | research |
| 05_cascade.md | research |
| crystal_shader.md | design |
| data_models.md | design |
| 06_state_machine.md | research |
| 07_random_generation.md | research |
| 08_performance.md | research |
| 09_future_work.md | research |
| 10_godot4_syntax.md | research |
| gravity_cascade.md | design |
| input_animation.md | design |
| match_system.md | design |
| state_machine.md | design (同名不同文件) |
| testing.md | design |
| ui_hud.md | design |
